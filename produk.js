...
const products = [
  {
    id: "P-001",
    name: "Piala Sepak Bola Gema Cup 2024 Ambon",
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola6.jpg",
      "image/sepakbola/pialasepakbola6.jpg",
      "image/sepakbola/pialasepakbola6.jpg",
    ],
    stock: "Ready",
    tags: ["Ukiran Laser", "Bahan Metal", "Base Marmer"],
    desc: `
    ...
    `,
    specs: {
      Ukuran: "Tinggi total 45 cm, Lebar Trophy 24 cm, Diameter dudukan 15 cm",
      Bahan: "Logam, Pita",
      Teknik: "Nikel, Hitam, Kuning",
    },
  },
  {
    id: "P-002",
    name: "Piala ESPEELSA Cup Lomba Futsal Putra Tingkat SD Se – Provinsi DIY",
    category: "Futsal",
    images: ["image/futsal/futsal2.webp", "image/futsal/futsal2.webp"],
    stock: "Pre-Order",
    tags: ["Bergilir", "Gravir Logo"],
    desc: `
    ...
    `,
    specs: {
      Ukuran: "Tinggi 30 cm, Diameter dudukan 9 cm",
      Bahan: "Logam",
      Teknik: "Kuningan cutting etsa cat",
    },
  },
  {
    id: "P-101",
    name: "Piala SOERABAJA CHAMPIONS LEAGUE",
    category: "Basket",
    images: [
      "image/basket/basket3.jpg",
      "image/basket/basket3.jpg",
      "image/basket/basket3.jpg",
    ],
    stock: "Ready",
    tags: ["Tema Klub", "Custom Logo"],
    desc: `
    ...
    specs: {
      Ukuran: "",
      Bahan: "Logam kuningan, kayu (dudukan)",
      Warna: "	Golf (piala utama), silver (variasi kombinasi), coklat (dudukan)",
    },
  },
  {
    id: "P-201",
    name: "Piala Sepak Bola Juara RSST Futsal Tournament 2024 Klaten",
    category: "Sepak Bola",
    images: ["image/futsal/futsal5.jpg", "image/futsal/futsal5.jpg"],
    stock: "Ready",
    tags: ["Full Custom", "Ukiran Laser"],
    desc: `
    ...
    specs: {
      Ukuran:
        "	Tinggi Total 30cm, Tinggi Badan 23.5cm, Tinggi dudukan 6.5cm, diameter dudukan 15.5cm",
      Bahan: "Resin dan Akrilik",
      Warna: "	Hitam, Gold, dan Hijau tosca",
    },
  },
  {
    id: "P-301",
    name: "Piala Bergilir E- Sport Mobile Legends RS Persahabatan Jakarta",
    category: "E-Sport",
    images: [
      "image/esport/esport6.jpg",
      "image/esport/esport6.jpg",
      "image/esport/esport6.jpg",
    ],
    stock: "Ready",
    tags: ["RGB Base", "Tema Game"],
    desc: `
    ...
    specs: {
      Ukuran:
        "Tinggi 42.5cm,Tinggi dudukan 7.5cm, Panjang 18cm, Lebar 14cm, Panjang Logo 28cm",
      Bahan: "	Logam, Resin",
      Warna: "Gold dan Hitam",
    },
  },
  {
    id: "G-002",
    ...
    `,
    specs: {
      Ukuran: "Diameter medali 6.5 cm",
      Bahan: "Logam, Tali medali",
      Teknik: "Kuningan etsa masir bolak balik krom emas, Nikel, Perunggu",
    },
  },
  {
    id: "G-001",
    name: "Medali Fun Run Bulan K3 Nasional 2025 PT Buma",
    category: "Medali",
    images: ["image/medali/medali2.jpg", "image/medali/medali2.jpg"],
    stock: "Pre-Order",
    tags: ["Laser Cut", "Kotak Premium"],
    desc: `
  ...
  `,
    specs: {
      Ukuran: "Diameter medali 6.5 cm, Tebal 8 mm",
      Bahan: "Logam, Akrilik, Tali 3 x 90 cm",
      Teknik: "Akrilik print UV, Kuningan etsa cat, Tali printing",
    },
  },
  {
    id: "",
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola2.jpg",
      "image/sepakbola/pialasepakbola2.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
    ...
    `,
    specs: {
      Ukuran: "Tinggi total 45 cm",
      Ukurandudukan: "Tinggi 9 cm, Panjang dan lebar 17 cm",
      Bahan: "Logam, Kayu",
      Teknik:
        "Kuningan piala dan bola full tatah finishing goldplate, Kuningan etsa poles cat",
    },
  },
  {
    id: "PSB 015",
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola3.jpg",
      "image/sepakbola/pialasepakbola3.jpg",
    ],
    stock: "Pre-Order",
    ...
    `,
    specs: {
      Ukuran: "Tinggi total 33 cm",
      Bahan: "Logam, resin",
      Teknik: "Plat transparasi silver",
    },
  },
  {
    id: "PSB 014",
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola4.jpg",
      "image/sepakbola/pialasepakbola3.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Duplikat Piala"],
    ...
    specs: {
      Ukuran: "Tinggi total 33 cm",
      Bahan: "Logam, Resin",
      Teknik: "Plat transparansi silver",
    },
  },
  {
    id: "PBE 013",
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola5.jpg",
      "image/sepakbola/pialasepakbola5.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Custom Event"],
    ...
    specs: {
      Ukuran:
        "Tinggi total 45 cm, Tinggi dudukan 9 cm, Panjang dan Lebar dudukan 18 cm",
      Bahan: "Logam, Kayu",
      Teknik: "Stainless esta cat, Logo Print UV",
    },
  },
  {
    id: "PSB 012",
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola7.jpg",
      "image/sepakbola/pialasepakbola7.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
    ...
    specs: {
      Ukuran:
        "Tinggi total 27.3cm, Tinggi dudukan 3.8cm, Panjang dan Lebar dudukan 6.7cm",
      Bahan: "	Resin, Kristal",
      Warna: "Gold, Hitam",
    },
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola8.jpg",
      "image/sepakbola/pialasepakbola8.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
    ...
    `,
    specs: {
      Ukuran: "	Tinggi 30cm, Diameter dudukan 11.6cm",
      Bahan: "Resin",
      Warna: "Nikel",
    },
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola10.jpg",
      "image/sepakbola/pialasepakbola10.jpg",
    ],
    stock: "Pre-Order",
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola11.jpg",
      "image/sepakbola/pialasepakbola11.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola12.jpg",
      "image/sepakbola/pialasepakbola12.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Piala Juara"],
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola13.jpg",
      "image/sepakbola/pialasepakbola13.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Piala Juara"],
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola14.jpg",
      "image/sepakbola/pialasepakbola14.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola15.jpg",
      "image/sepakbola/pialasepakbola15.jpg",
    ],
    stock: "Pre-Order",
  ...
  },
  {
    ...
    category: "Sepak Bola",
    images: [
      "image/sepakbola/pialasepakbola17.jpg",
      "image/sepakbola/pialasepakbola17.jpg",
    ],
    stock: "Pre-Order",
    tags: ["Emas", "Perak", "Perunggu", "Custom Event"],
    ...
    specs: {
      Ukuran: "	Silver, Hitam",
      Bahan: "Logam cor, plat kuningan, resin",
    },
  },
  //Basket
  {
    ...
    specs: {
      Ukuran:
        "Tinggi 45 cm, Lebar trophy 10 cm, Lebar trophy 6.7 cm, Diameter bola 10 cm",
      Bahan: "Resin",
      Box: "Bludru hitam satin emas",
      Teknik:
        "Badan piala cor resin krom emas pvd master 3D, Kuningan graji dan etsa krom emas",
    },
  },
  {
    id: "PBA 006",
    ...
    specs: {
      Ukuran:
        "Tinggi total 20 cm, Tinggi dudukan 4 cm, Diameter dudukan 7.5 cm",
      Bahan: "Akrilik, Resin",
      Warna: "Bening, Hitam",
  ...
  //Futsal
  {
    ...
    `,
    specs: {
      Ukuran: "Tinggi total 62.5 cm, Tali 3 x 90 cm",
      Bahan: "Piala dan figur stock, Logam, Tali",
      Teknik: "Stainless etsa cat, tali printing bolak balik",
    },
  },
  {
    id: "PBE 015",
  ...
  //E-SPORT--------------------------------------------------------------------------------------------
  {
    ...
    specs: {
      Ukuran:
        "Tinggi total 32 cm, Tinggi dudukan 5 cm, Panjang dudukan 8 cm, Lebar dudukan 7 cm",
      Bahan: "Resin, Logam",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi total 25 cm, Panjang akrilik logo ML 20.6 cm, Tebal 3.2 cm, Tinggi dudukan 5 cm, Panjang dan Lebar dudukan 10 cm",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi total 35cm, TInggi dudukan 7cm, Tinggi Badan 28cm, Lebar badan 14cm Tebal 2.5cm, Dudukan panjang dan lebar 11cm",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi Total 45cm, Tinggi dudukan 9cm, Tinggi Badan 36cm, Diameter dudukan 15.5cm",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi 18 cm, Tinggi dudukan 4 cm, Panjang dan Lebar dudukan 6.8 cm",
      Bahan: "Kristal",
      Box: "Bludru Hitam Satin Emas",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi total 20 cm, Tinggi dudukan 4 cm, Panjang dudukan 9 cm, Lebar dudukan 6 cm",
      Bahan: "Akrilik, Resin",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi 18 cm, Lebar 15.5 cm, Tebal 1.5 cm, Tinggi dudukan 3.5 cm, Lebar 4 cm, Panjang dudukan 15 cm",
  ...
  },
  {
    ...
    specs: {
      Ukuran:
        "Tinggi Total 18cm, Tinggi dudukan 3.5cm Panjang dudukan 15cm, Lebar dudukan 4cm, Tebal Akrilik 1.5cm",
...
(() => {
  ...
  function openWA(p) {
    const msg =
      `Halo Troppion,%0ASaya tertarik dengan produk:%0A- Nama: ${encodeURIComponent(
        p.name || ""
      )}` +
      `%0A- Kategori: ${encodeURIComponent(
        p.category || ""
      )}%0A%0ATolong info ketersediaan & waktu produksi.`;
    window.open(`https://wa.me/${PHONE}?text=${msg}`, "_blank");
  }
  document.getElementById("mChat").addEventListener("click", () => {
    if (mProd) openWA(mProd);
  });
